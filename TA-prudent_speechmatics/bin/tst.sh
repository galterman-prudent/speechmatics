...
WATCHDIR=$SPLUNK_HOME/TA-prudent_speechmatics/data/Watchfolder
SOURCEDIR=$SPLUNK_HOME/TA-prudent_speechmatics/data/ToDo
DONEDIR=$SPLUNK_HOME/TA-prudent_speechmatics/data/Done
OUTPUTDIR=$SPLUNK_HOME/TA-prudent_speechmatics/data/Output
USER=splunk
